...
@Service
public class GetAllFollowedService extends AbstractFollowerService {

    public GetAllFollowedService(UserRepository userRepository) {
        super(userRepository);
    }

    @Override
    protected Optional<List<User>> findInDatabaseByIdUser(Integer userId) {
        return userRepository.findAllFollowedByUserId(userId);
    }
}
